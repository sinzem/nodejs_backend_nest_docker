...
@Module({
  ...
  imports: [
    SequelizeModule.forFeature([User, Role, UserRoles, Post]), /* (подключаем модели используемых таблиц(User будет связан с Role как многие-ко-многим через таблицу UserRole)) */
